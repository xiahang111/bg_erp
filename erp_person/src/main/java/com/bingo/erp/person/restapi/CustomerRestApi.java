...
public class CustomerRestApi {
    ...
    public String getCustomerByAdminUid(HttpServletRequest request) {
        ...
        try {
            return ResultUtil.result(SysConf.SUCCESS, customerInfoService.getCustomerByAdminUid(adminUid));
        }catch (Exception e){
    ...
    public String saveCustomerByOrder(HttpServletRequest request, @RequestBody CustomerVO customerVO){
        ...
        customerInfoService.saveCustomerByOrder(customerVO);
