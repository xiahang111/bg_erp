...
public class TrackingTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Get tracking results of a single tracking.
             String	urlStr ="/yimidida/700468297542CN";
             String requestData=null;
             String result = new TrackingTest().orderOnlineByJson(requestData,urlStr,"codeNumberGet");
    ...
    /** Apikey*/
    private String Apikey="fc594ac9-68ec-4ba4-9b42-603dea163b1b";
    /**
     * Json
     */
    public String orderOnlineByJson(String requestData,String urlStr,String type) throws Exception{
        ...
        String result =null;
        if(type.equals("post")){
            String ReqURL="http://api.51tracking.com/v2/trackings/post";
            bodyParams.add(requestData);
            result=sendPost(ReqURL, headerparams , bodyParams,"POST");

        }else if(type.equals("get")){

            String ReqURL="http://api.51tracking.com/v2/trackings/get";
            String RelUrl = ReqURL+urlStr;
            result=sendPost(RelUrl, headerparams , bodyParams,"GET");

        }else if(type.equals("batch")){

            String ReqURL="http://api.51tracking.com/v2/trackings/batch";
            bodyParams.add(requestData);
            result=sendPost(ReqURL, headerparams , bodyParams,"POST");

        }else if(type.equals("codeNumberGet")){

            String ReqURL="http://api.51tracking.com/v2/trackings";
            String RelUrl = ReqURL+urlStr;
            ...
            String ReqURL="http://api.51tracking.com/v2/carriers";
            result=sendGet(ReqURL, headerparams ,"GET");

        }else if(type.equals("update")){

            String ReqURL="http://api.51tracking.com/v2/trackings/update";
            bodyParams.add(requestData);
            result=sendPost(ReqURL, headerparams , bodyParams,"POST");

        }else if(type.equals("getuserinfo")){

            String ReqURL="http://api.51tracking.com/v2/trackings/getuserinfo";
            result=sendGet(ReqURL, headerparams ,"GET");

        }else if(type.equals("getstatusnumber")){

            String ReqURL="http://api.51tracking.com/v2/trackings/getstatusnumber";
            result=sendGet(ReqURL, headerparams , "GET");

        }else if(type.equals("notupdate")){

            String ReqURL="http://api.51tracking.com/v2/trackings/notupdate";
            bodyParams.add(requestData);
            result=sendPost(ReqURL, headerparams , bodyParams,"POST");

        }else if(type.equals("remote")){

            String ReqURL="http://api.51tracking.com/v2/trackings/remote";
            bodyParams.add(requestData);
            result=sendPost(ReqURL, headerparams , bodyParams,"POST");

        }else if(type.equals("costtime")){

            String ReqURL="http://api.51tracking.com/v2/trackings/costtime";
            bodyParams.add(requestData);
            result=sendPost(ReqURL, headerparams , bodyParams,"POST");

        }else if(type.equals("delete")){

            String ReqURL="http://api.51tracking.com/v2/trackings/delete";
            bodyParams.add(requestData);
            result=sendPost(ReqURL, headerparams , bodyParams,"POST");

        }else if(type.equals("updatemore")){

            String ReqURL="http://api.51tracking.com/v2/trackings/updatemore";
            bodyParams.add(requestData);
            result=sendPost(ReqURL, headerparams , bodyParams,"POST");
